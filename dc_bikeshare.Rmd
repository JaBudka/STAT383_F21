...
```{r recode holiday and workingday}
dcbikeshare <- dcbikeshare %>%
  mutate(
...
```{r bike rental vs feeling temperature}
cnt_atmp <- linear_reg() %>%
  set_engine("lm") %>%
